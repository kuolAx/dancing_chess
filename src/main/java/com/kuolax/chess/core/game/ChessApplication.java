...
public class ChessApplication extends GameApplication {
    ...
    private void showGameOverDialog() {
        ...
        String message = switch (state) {
            ...
            case DRAW -> "Draw due to exceeding the move limit.";
            case DRAW_BY_REPETITION -> "Draw due to threefold repetition.";
            case DRAW_BY_INSUFFICIENT_MATERIAL -> "Draw due to insufficient material.";
            default -> "Game ended";
        };
